...
    
    // El ID de Transacción en Supabase es el campo 'order_number' de Plisio, pero si usas 'txn_id', mantendremos eso.
    // 💡 NOTA: En tu código base de Plisio (create-plisio-invoice.js) se usa 'order_number', 
    // pero aquí usas 'txn_id'. Asumiré que txn_id es el id_transaccion de Supabase.
